...
import type { CairnMemoryToolHandlers } from './sdk-adapter.js';

type IsAssignable<A, B> = A extends B ? true : false;

/** Fails to compile (`false` not assignable to `true`) on SDK drift. */
export const SDK_MEMORY_TOOL_CANARY: IsAssignable<CairnMemoryToolHandlers, MemoryToolHandlers> = true;
